...
export const editWork = async ({ _id, title, genre, synopsis, authorName, authUser, writingStage, createdBy }) => {
  console.log(_id, title, genre, synopsis, authorName, authUser, writingStage, createdBy);
  return null;
};
